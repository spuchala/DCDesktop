...
.controller('homeController', ['backgroundService', '$scope', '$timeout',
    function (backgroundService, $scope, $timeout) {
        ...
        $scope.images = [
            ...
            { id: 2, image: 'images/assistant.png', title: 'Introducing GigglesWare smart Assitant. Tap! Talk! and we load the reports', show: false, color: 'black', knowMore: 'features/dvAssistant', knowMoreText: 'Know More', textOnBackGroundColor: true },            
